...
- Sahil ChowKekar - Initial work and maintenance

## 🙏 Acknowledgments

- Apple's SwiftUI and MapKit documentation
- SwiftUI community for inspiration and best practices
- Contributors who helped improve the project
- MapKit and CoreLocation engineering teams
...
- Check the [Wiki](https://github.com/yourusername/MapsSwiftUI/wiki) (if available)
- Join our [Discord community](https://discord.gg/yourdiscord) (if available)
